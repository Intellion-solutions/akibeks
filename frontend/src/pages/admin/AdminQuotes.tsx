...
const AdminQuotes = () => {
  ...
  const handleCreateQuote = async () => {
    ...
    try {
      ...
      // Create quote with empty quote_number - it will be auto-generated by the database trigger
      const { data: quote, error: quoteError } = await supabase
        ...
        .insert({
          ...
          quote_number: '' // This will be auto-generated by the database trigger
        })
        .select()
        .single();
